...
\begin{figure}[H]
    \centering
    \subfloat[Sparse Area]{\label{fig:sparse}\includegraphics[width=6cm]{src/images/SmartDataCompressionI}}
    \qquad
    \subfloat[Dense Area]{\label{fig:dense}\includegraphics[width=6cm]{src/images/SmartDataCompressionII}}
