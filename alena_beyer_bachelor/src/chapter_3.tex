...
\\*
\textbf{T2: Clustering}\\*
Clustering is the process of finding expressive groups (clusters) out of the data. Therefore, the dataset is devided into subgroups according to some similarity measure. In the time domain whole time series can be clustered or only subsequences.  
\\*
\textbf{T3: Classification}\\*
Classification assigns label to the data from a set of labels. 
\\*
...
Pattern discovery finds regularly appearing structures in a time series. 
